...
import 'package:regentspacevtu/demo_pages/attachments/buyairtime.dart';
import 'package:regentspacevtu/demo_pages/attachments/buydata.dart';
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            /// Services Grid
            const Text("Top-up Services", style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
            GridView.count(
              crossAxisCount: 4,
              shrinkWrap: true,
            ...
            /// Ads Carousel
            const Text("Advertisements", style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
            CarouselSlider(
