      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: _selectedNetwork == name
                                ? const Color.fromARGB(255, 250, 137, 45)
                                : Colors.transparent,
                            width: 2,
                          ),
                        ),
                ...
                items: widget.plans.map((plan) {
                  return DropdownMenuItem(
                    ...
                    child: Text(
                      plan,
                      style: const TextStyle(
                          color: Color.fromARGB(255, 235, 132, 15),
                          fontSize: 16,
            ...
            TextFormField(
              style: const TextStyle(
                color: Color.fromARGB(255, 175, 97, 7),
                fontSize: 16,
                fontWeight: FontWeight.w500,
              ),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isFormValid
                      ? const Color.fromARGB(255, 242, 128, 20)
            ...
            const Center(
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: Color.fromARGB(255, 231, 107, 6)
                ),
              ),
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color.fromARGB(255, 250, 145, 58),
